...
static void printusage(void)
{
    ...
    puts("-iop2x - Experimental, set bus and ARM clock to WiiU speed as well, only use this if you know what you're "
         "doing");
    waitforenter();
}
...
{
    puts("cafe2wii Patcher v1.3 by RMatsuura");
    int argPos;
